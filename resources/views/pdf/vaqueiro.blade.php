...
<head>
    ...
    <style>
        ...
        .comprovante { margin-top: 20px; border-top: 1px solid #000; padding-top: 10px; }
        .page-break { page-break-before: always; }
        .pagina-divisao { page-break-after: always; }
        .senha-card { page-break-inside: avoid; margin-bottom: 10px; }
...
<div class="disputa-set">
    ...
    <div class="comprovante">
        <div class="linha-fina"></div>
        <div class="header">Comprovante De Senha</div>
        <div class="linha-fina"></div>
        ...
        <div class="info">
            <span class="label">Data:</span> {{ optional($vaqueiro->data)->format('d/m/Y') ?? now()->format('d/m/Y') }}
        </div>
