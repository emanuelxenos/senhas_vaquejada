                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="forma_pagamento" id="forma_pagamento" class="form-select @error('forma_pagamento') is-invalid @enderror" required>
                                ...
                                <option value="Pix" {{ old('forma_pagamento', $inscricao->forma_pagamento) == 'Pix' ? 'selected' : '' }}>Pix</option>
                                <option value="Cartão" {{ old('forma_pagamento', $inscricao->forma_pagamento) == 'Cartão' ? 'selected' : '' }}>Cartão</option>
