    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h4 class="mb-0">
                    <i class="fas fa-user-edit"></i> Editar Competidor
                </h4>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('competidores.update', $competidor) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="nome" id="nome" class="form-control @error('nome') is-invalid @enderror"
                                   value="{{ old('nome', $competidor->nome) }}" required>
                            @error('nome')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="cpf" id="cpf" class="form-control @error('cpf') is-invalid @enderror"
                                   value="{{ old('cpf', $competidor->cpf) }}" placeholder="000.000.000-00" required>
                            @error('cpf')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="cidade" id="cidade" class="form-control @error('cidade') is-invalid @enderror"
                                   value="{{ old('cidade', $competidor->cidade) }}" required>
                            @error('cidade')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="representacao" id="representacao" class="form-control @error('representacao') is-invalid @enderror"
                                   value="{{ old('representacao', $competidor->representacao) }}" placeholder="Ex: Rancho XYZ" required>
                            @error('representacao')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
